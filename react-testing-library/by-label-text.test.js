...
describe("ByLabelText", () => {
  describe("Element examples", () => {
    test("htmlFor relationship", () => {
      ...
      expect(screen.getByLabelText("Example"));
    });
  ...
  describe("Queries", () => {
    ...
    describe("queryBy/queryAllBy", () => {
      ...
      test("1 match", () => {
        ...
        expect(screen.queryByLabelText("Example"));
  ...
  describe("Query attributes", () => {
    test("exact", () => {
      ...
      expect(screen.getByLabelText("Ex", { exact: false }));
    });
    ...
    test("selector", () => {
      ...
      expect(screen.getByLabelText("Example", { selector: "input" }));
    });
